...
# Execute code
echo matlab -nodisplay -nodesktop -singleCompThread -nosplash -r "WORKING_valid_path_direct_sdh();quit;"
matlab -nodisplay -nodesktop -singleCompThread -nosplash -r "WORKING_valid_path_direct_sdh();quit;"
