...
# Execute code
echo matlab -nodisplay -nodesktop -singleCompThread -nosplash -r "WORKING_high_res_imm_sdh();quit;"
matlab -nodisplay -nodesktop -singleCompThread -nosplash -r "WORKING_high_res_imm_sdh();quit;"
