function WORKING_sdh_sidewall_scan(array_idx, total_jobs)
...
new_options.savepath = '/work/mc16535/Matlab_Sidewalls/array-sidewalls-imaging/sdh-scan';
...
new_options.savename = sprintf('Sens Contact SDH Scan - %d', array_idx);
new_options.geom_shape.xmin = xmins(array_idx);
new_options.geom_shape.xmax = xmaxs(array_idx);
