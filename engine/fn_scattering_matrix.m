...
if scat_info.type == "sdh"
    ...
    for i = 1:ang_pts_over_2pi
        for j = 1:ang_pts_over_2pi
            scat_matrix(1).matr(i, j) = fn_sdh_scatterer_amp( ...
                inc_angle(j), out_angle(i), sdh_radius, lambda_L, lambda_T, 0, 0 ...
            );
            scat_matrix(2).matr(i, j) = fn_sdh_scatterer_amp( ...
                inc_angle(j), out_angle(i), sdh_radius, lambda_L, lambda_T, 0, 1 ...
            );
            scat_matrix(3).matr(i, j) = fn_sdh_scatterer_amp( ...
                inc_angle(j), out_angle(i), sdh_radius, lambda_L, lambda_T, 1, 0 ...
            );
            scat_matrix(4).matr(i, j) = fn_sdh_scatterer_amp( ...
                inc_angle(j), out_angle(i), sdh_radius, lambda_L, lambda_T, 1, 1 ...
            );
        end
    end
elseif scat_info.type == "crack"
    ...
    for i = 1:ang_pts_over_2pi
        for j = 1:ang_pts_over_2pi
            scat_matrix(1).matr(i, j) = fn_crack_scatterer_amp( ...
                inc_angle(j), out_angle(i), density, vel_L, vel_T, ...
                frequency, 0, 0, crack_length, nodes_per_wavelength ...
            );
            scat_matrix(2).matr(i, j) = fn_crack_scatterer_amp( ...
                inc_angle(j), out_angle(i), density, vel_L, vel_T, ...
                frequency, 0, 1, crack_length, nodes_per_wavelength ...
            );
            scat_matrix(3).matr(i, j) = fn_crack_scatterer_amp( ...
                inc_angle(j), out_angle(i), density, vel_L, vel_T, ...
                frequency, 1, 0, crack_length, nodes_per_wavelength ...
            );
            scat_matrix(4).matr(i, j) = fn_crack_scatterer_amp( ...
                inc_angle(j), out_angle(i), density, vel_L, vel_T, ...
