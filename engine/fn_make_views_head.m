function Views = fn_make_views_head(Paths, unique_only)
...
% % Remove invalid head views.
% for view = 1:no_paths^2
%     path1 = Paths(tx_rx_idxs(view,1));
%     path2 = Paths(tx_rx_idxs(view,2));
%     if or(isstruct(path1.path_info.path_geometry), isstruct(path2.path_info.path_geometry))
%         if or(path1.path_info.path_geometry.name == "F", path2.path_info.path_geometry.name == "F")
%             a = 1;
%         end
%     end
% end
